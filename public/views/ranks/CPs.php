                                        ...
                                        <table class="nice_table" cellspacing="0" cellpadding="0">
                                            <tbody>
                                              <tr>
                                                ...
                                                <td width="15%" align="center">ConquerPoints</td>
                                            </tr>
                                            <?php
                                            $i = 1;
                                            $get = $app->get_cps();
                                            foreach ($get as $row) {
                                                ...
                                                $guildname = $app->get_char_guild_name($row['GuildID']);
                                                        ...
                                                        echo '<td width="15%" align="center" data-class="'.$row['Class'].'">' . $class . '</td>';
                                                        echo '<td width="15%" align="center">' . number_format($row['ConquerPoints']) . '</td>';
                                                        echo "</tr>";
                                                        $i++;
                                            }
                                            ?>
